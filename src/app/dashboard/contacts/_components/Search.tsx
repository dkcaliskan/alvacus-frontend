...
const SearchContactsDashboard: FunctionComponent = () => {
  ...
  // Get the users data for showing the count in the placeholder
      ...
      >
        <label className='label' htmlFor='search'>
          <div className='flex items-center'>
            ...
            />
            <span className='label-text line-clamp-1 pl-2 text-xl'>Search</span>
          </div>
        </label>
...
export default SearchContactsDashboard;
