...
// Types
import { CalculatorCardTypes } from '@/types/calculators.d';

const CalculatorCard: FunctionComponent<CalculatorCardTypes> = ({
  calculator,
}) => {
          ...
          <div className='flex items-center -mt-[5px]'>
            {user &&
              ...
              (calculator.author._id === user.userId ||
                user.role === 'admin') && (
                <EditLink calcType={calculator.type} calcId={calculator._id} />
              )}
